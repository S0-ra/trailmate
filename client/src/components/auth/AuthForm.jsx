    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.role === "admin") {
          ...
          navigate("/vendor"); // Redirect to the default page for non-admin users
        } else {
          navigate("/");
        }
      } else {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-2 rounded-3xl max-w-4xl">
        ...
        <div className="border rounded-2xl px-14 py-8">
          ...
          <form onSubmit={handleRegisterSubmit}>
            ...
            <input
              type="tel"
              name="phoneno" // Correct name here
            ...
            <label htmlFor="confirmPassword" className="text-xs m-1 font-md">
              Confirm Password
            </label>
            <input
              type="password"
              name="confirmPassword" // Correct name here
